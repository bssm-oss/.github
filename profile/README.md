...
| Project | Description | Lead | Tags |
| --- | --- | --- | --- |
| [cli-speedrun](https://github.com/bssm-oss/cli-speedrun) | Terminal command typing speed-run game | [@justn-hyeok](https://github.com/justn-hyeok) | `Rust` `CLI` `Game` |
| [dep-age](https://github.com/bssm-oss/dep-age) | CLI that visualizes how old a project's dependencies are | [@justn-hyeok](https://github.com/justn-hyeok) | `CLI` |
| [git-roast](https://github.com/bssm-oss/git-roast) | CLI that analyzes commit history to roast the developer | [@justn-hyeok](https://github.com/justn-hyeok) | `TypeScript` `CLI` |
...
| [port-who](https://github.com/bssm-oss/port-who) | Pretty CLI for identifying which process is using a port | [@justn-hyeok](https://github.com/justn-hyeok) | `Zig` `CLI` |
...
| Project | Description | Lead | Tags |
| --- | --- | --- | --- |
| [better-notion2pdf](https://github.com/bssm-oss/better-notion2pdf) | Readability-focused Notion PDF converter with smart page breaks | [@justn-hyeok](https://github.com/justn-hyeok) | `TypeScript` `Notion` `PDF` |
