...
| --- | --- | --- | --- |
| [kakao-talk-auto-bot](https://github.com/bssm-oss/kakao-talk-auto-bot) | Android app that sends AI auto-replies to KakaoTalk notifications from selected rooms | [@heodongun](https://github.com/heodongun) | `Kotlin` `AI` `Android` `Automation` |
...
| [cotor](https://github.com/bssm-oss/cotor) | Local-first AI workflow runner with Kotlin core across CLI, TUI, local app, server, and desktop shell | [@heodongun](https://github.com/heodongun) | `Kotlin` `AI` `Android` `CLI` |
| [globalAI](https://github.com/bssm-oss/globalAI) | Go CLI that collects and displays local AI instruction files — AGENTS.md, CLAUDE.md, .claude, and more | [@heodongun](https://github.com/heodongun) | `Go` `AI` `CLI` |
| [AICall](https://github.com/bssm-oss/AICall) | Android AI call companion with Telecom role integration, STT/TTS assistant flow, and Codex-compatible backend hooks | [@heodongun](https://github.com/heodongun) | `Kotlin` `AI` `Android` |
| [AIStudyWeb](https://github.com/bssm-oss/AIStudyWeb) | Go-based RewardLab for exploring epsilon-greedy multi-armed bandit learning via a local web interface | [@heodongun](https://github.com/heodongun) | `Go` `AI` `Web` `Knowledge` |
...
| [claudeCode-codex-](https://github.com/bssm-oss/claudeCode-codex-) | Clean-room Go implementation of a terminal coding agent for OpenAI and Codex-compatible backends | [@heodongun](https://github.com/heodongun) | `Go` `AI` |
| [Free-API](https://github.com/bssm-oss/Free-API) | Go CLI that detects installed AI CLIs and auto-switches between free LLM providers | [@heodongun](https://github.com/heodongun) | `Go` `AI` `CLI` `Automation` |
| [pandaAPI](https://github.com/bssm-oss/pandaAPI) | Go CLI that drives ChatGPT and Gemini web interfaces via browser automation instead of official APIs | [@heodongun](https://github.com/heodongun) | `Go` `AI` `CLI` `Automation` |
...
| Project | Description | Lead | Tags |
| --- | --- | --- | --- |
| [cinderella](https://github.com/bssm-oss/cinderella) | macOS app that turns your laptop into a typewriter and pumpkin after work hours | [@heodongun](https://github.com/heodongun) | `Swift` `macOS` |
| [desktop-pet](https://github.com/bssm-oss/desktop-pet) | Native desktop pet app that displays GIF, APNG, PNG sequences, and video on screen | [@BitByte08](https://github.com/BitByte08) | `Swift` `macOS` |
...
| [LovaSlap](https://github.com/bssm-oss/LovaSlap) | Prototype app that reacts when you hit your MacBook | [@BitByte08](https://github.com/BitByte08) | `Swift` `macOS` `Toy App` |
| [LovaSlap-PET](https://github.com/bssm-oss/LovaSlap-PET) | Desktop pet that hurts when you hit your MacBook | [@BitByte08](https://github.com/BitByte08) | `Swift` `macOS` `Toy App` |
...
| Project | Description | Lead | Tags |
| --- | --- | --- | --- |
| [bssm-oss-badges](https://github.com/bssm-oss/bssm-oss-badges) | Dynamic SVG badge service for bssm-oss organization README | [@justn-hyeok](https://github.com/justn-hyeok) | `TypeScript` `Infra` |
| [dotx](https://github.com/bssm-oss/dotx) | Universal config manager for AI coding tools — mix, switch, and share Claude/Cursor/Windsurf presets | [@justn-hyeok](https://github.com/justn-hyeok) | `Go` `CLI` `AI` |
| [ez-brew](https://github.com/bssm-oss/ez-brew) | CLI for creating and publishing Homebrew packages with minimal setup | [@justn-hyeok](https://github.com/justn-hyeok) | `Go` `CLI` `Infra` |
| [setup.sh](https://github.com/bssm-oss/setup.sh) | Bash script automating Java, Docker, and Docker Compose setup on Ubuntu/Debian | [@HyunwooKiim](https://github.com/HyunwooKiim) | `Shell` `Infra` `Automation` |
...
| Project | Description | Lead | Tags |
| --- | --- | --- | --- |
| [good-opensource-zip](https://github.com/bssm-oss/good-opensource-zip) | Curated list of useful open-source AI and research projects | [@heodongun](https://github.com/heodongun) | `AI` `Curation` |
| [obsidian-skills-codex](https://github.com/bssm-oss/obsidian-skills-codex) | Collection of CLI skills for Obsidian | [@heodongun](https://github.com/heodongun) | `Obsidian` `CLI` `Knowledge` |
...
| Project | Description | Lead | Tags |
| --- | --- | --- | --- |
| [shitty-justn](https://github.com/bssm-oss/shitty-justn) | personal junk drawer — CLI tools, browser extensions, macOS utilities, and half-finished ideas | [@justn-hyeok](https://github.com/justn-hyeok) | `Misc` |
...
| [digg](https://github.com/bssm-oss/digg) | seed a song. discover where it leads. | [@justn-hyeok](https://github.com/justn-hyeok) | `TypeScript` `Python` `Music` |
